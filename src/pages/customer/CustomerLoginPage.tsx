      ...
      <div className="flex-1 bg-card -mt-6 rounded-t-3xl px-6 pt-8 pb-6">
        ...
        <div className="mt-6 text-center max-w-sm mx-auto">
          ...
          <div className="flex justify-center gap-4">
            {["G", "f", "🍎"].map((icon, i) => (
              <button key={i} className="h-12 w-12 rounded-full border border-border flex items-center justify-center hover:bg-secondary transition-colors text-lg font-bold">{icon}</button>
            ))}
          </div>
        </div>
