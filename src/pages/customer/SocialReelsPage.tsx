...
import { Heart, MessageCircle, Send, Bookmark, MoreHorizontal, Music2, Plus, Search, Home, Play, Film } from "lucide-react";
...
export default function SocialReelsPage() {
  ...
  // On desktop show with sidebar, on mobile show fullscreen
  return (
    <>
      <div className="hidden md:block">
        <SocialLayout hideRightSidebar>{reelsContent}</SocialLayout>
      </div>
